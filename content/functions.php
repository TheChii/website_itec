<?php
	...
	function return_command($keywords, $verses, $lines, $rhyme, $theme){
		$to_return =  "a poem with " . $rhyme . " rhyme, " . $verses . " verses, ". $lines . " lines and " . " keywords: " . $keywords . ", theme: ". $theme . ", only poem no verse count";
	...
	function add_poem_to_db($con, $content, $keywords, $theme, $author, $image, $rhyme){
		$content = mysqli_real_escape_string($con, $content);
		$sql_code = "INSERT INTO poems(content, keywords, theme, author, img, rhyme) VALUES ('$content', '$keywords', '$theme', '$author', '$image', '$rhyme');";
		return mysqli_query($con, $sql_code) ? true : false;
	}
?>